    ...
    focus: [
      {
        ...
        desc: "OpenAI LLM, RAG pipelines, chatbots, and holographic AI avatars for immersive experiences.",
      },
      {
        title: "Cloud Architecture",
        desc: "AWS/Vultr deployment, Docker, Kubernetes, CI/CD pipelines for scalable production systems.",
      },
      {
        title: "Digital Transformation",
        desc: "Building end-to-end solutions that bridge technology and business impact through innovation.",
      },
    ],
    ...
    items: [
      {
        ...
        company: "@ CREaiVE.ai",
        desc: "Building CMS platforms, AI chatbots with holographic displays, and e-commerce solutions. Pioneering AI Human avatar technology.",
      },
      {
        period: "2021 - 2024",
        role: "AI Researcher & Teaching Assistant",
        company: "@ KMUTT",
        desc: "Developed computer vision for PPE detection (Panasonic) and speech recognition systems for medical rehabilitation (NSTDA).",
      },
      {
        period: "2019 - 2020",
        role: "Electrical Engineering Intern",
        company: "@ Seagate Technology Thailand ,Ltd",
        desc: "Built full-stack inventory management system managing 300+ warehouse products with React, Node.js, and SQL.",
      },
    ],
  },
  education: {
    ...
    items: [
      {
        degree: "Master of Electrical Engineering (Dropout)",
...
const th: Dict = {
  ...
  about: {
    ...
    focusTitle: "สิ่งที่ให้ความสำคัญในตอนนี้",
    focus: [
      {
        title: "การผสาน AI",
        desc: "OpenAI LLM, ไปป์ไลน์ RAG, แชตบอต และอวาตาร์ AI แบบโฮโลแกรมเพื่อประสบการณ์ที่ดื่มด่ำ",
      },
      {
        title: "สถาปัตยกรรมคลาวด์",
        desc: "การดีพลอย AWS/Vultr, Docker, Kubernetes, ไปป์ไลน์ CI/CD สำหรับระบบที่ขยายได้",
      },
      {
        title: "การเปลี่ยนผ่านสู่ดิจิทัล",
        desc: "สร้างโซลูชันแบบครบวงจรที่เชื่อมเทคโนโลยีเข้ากับผลกระทบทางธุรกิจผ่านนวัตกรรม",
      },
    ],
    ...
    items: [
      {
        ...
        company: "@ CREaiVE.ai",
        desc: "สร้างแพลตฟอร์ม CMS, แชตบอต AI พร้อมจอแสดงผลโฮโลแกรม และโซลูชันอีคอมเมิร์ซ บุกเบิกเทคโนโลยีอวาตาร์ AI Human",
      },
      {
        period: "2021 - 2024",
        role: "นักวิจัย AI และผู้ช่วยสอน",
        company: "@ KMUTT",
        desc: "พัฒนาคอมพิวเตอร์วิทัศน์สำหรับตรวจจับอุปกรณ์ PPE (Panasonic) และระบบรู้จำเสียงพูดเพื่อการฟื้นฟูทางการแพทย์ (NSTDA)",
      },
      {
        period: "2019 - 2020",
        role: "นักศึกษาฝึกงานวิศวกรรมไฟฟ้า",
        company: "@ Seagate Technology Thailand ,Ltd",
        desc: "สร้างระบบจัดการคลังสินค้าแบบ Full-Stack จัดการสินค้ากว่า 300 รายการด้วย React, Node.js และ SQL",
      },
    ],
  },
  education: {
    ...
    items: [
      {
        degree: "ปริญญาโท วิศวกรรมไฟฟ้า (ไม่จบ)",
...
const zh: Dict = {
  ...
  about: {
    ...
    focus: [
      {
        title: "AI 集成",
        desc: "OpenAI LLM、RAG 流水线、聊天机器人以及打造沉浸式体验的全息 AI 虚拟形象。",
      },
      {
        title: "云架构",
        desc: "AWS/Vultr 部署、Docker、Kubernetes、CI/CD 流水线，构建可扩展的生产系统。",
      },
      {
        title: "数字化转型",
        desc: "通过创新构建端到端解决方案，连接技术与业务价值。",
      },
    ],
    techTitle: "技术专长",
    ...
    items: [
      {
        ...
        role: "全栈开发者",
        company: "@ CREaiVE.ai",
        desc: "构建 CMS 平台、带全息显示的 AI 聊天机器人以及电商解决方案。率先开创 AI 数字人虚拟形象技术。",
      },
      {
        period: "2021 - 2024",
        role: "AI 研究员 & 助教",
        company: "@ KMUTT",
        desc: "为 PPE 检测开发计算机视觉（Panasonic），并为医疗康复开发语音识别系统（NSTDA）。",
      },
      {
        period: "2019 - 2020",
        role: "电气工程实习生",
        company: "@ Seagate Technology Thailand ,Ltd",
        desc: "使用 React、Node.js 和 SQL 构建全栈库存管理系统，管理 300 多种仓库产品。",
      },
    ],
  },
  education: {
...
const ja: Dict = {
  ...
  about: {
    ...
    focus: [
      {
        title: "AI 統合",
        desc: "OpenAI LLM、RAG パイプライン、チャットボット、没入型体験のためのホログラフィック AI アバター。",
      },
      {
        title: "クラウドアーキテクチャ",
        desc: "AWS/Vultr 展開、Docker、Kubernetes、スケーラブルな本番システムのための CI/CD パイプライン。",
      },
      {
        title: "デジタルトランスフォーメーション",
        desc: "イノベーションを通じて技術とビジネス成果を橋渡しするエンドツーエンドのソリューションを構築。",
      },
    ],
    techTitle: "技術的専門性",
    ...
    items: [
      {
        ...
        role: "フルスタック開発者",
        company: "@ CREaiVE.ai",
        desc: "CMS プラットフォーム、ホログラフィック表示の AI チャットボット、EC ソリューションを構築。AI ヒューマンアバター技術を開拓。",
      },
      {
        period: "2021 - 2024",
        role: "AI 研究者 & ティーチングアシスタント",
        company: "@ KMUTT",
        desc: "PPE 検出のためのコンピュータービジョン（Panasonic）と、医療リハビリのための音声認識システム（NSTDA）を開発。",
      },
      {
        period: "2019 - 2020",
        role: "電気工学インターン",
        company: "@ Seagate Technology Thailand ,Ltd",
        desc: "React、Node.js、SQL で 300 以上の倉庫製品を管理するフルスタックの在庫管理システムを構築。",
      },
    ],
  },
  education: {
