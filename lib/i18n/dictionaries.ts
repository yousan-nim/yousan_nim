...
const en: Dict = {
  ...
  about: {
    title: "About Me",
    p1: "Senior Full-Stack Developer who builds products grounded in SOLID principles and proven design patterns — engineering codebases that scale safely and stay stable in production.",
    p2pre: "Led a 3-engineer team end-to-end from discovery to production deployment; architected a ",
    p2highlight: "Smart Building IoT platform",
    p2post:
      " now serving 3 B2B clients — cutting API latency ~8s → ~2s and reducing backend load by ~33%.",
    p3pre: "Also shipped a multi-vendor BLE healthcare app on ",
    p3mid: "",
    p3highlight: "Google Play & App Store",
    p3post: ". Seeking a Senior Full-Stack role to deliver products with engineering rigor, security, and operational stability.",
  ...
  contact: {
    ...
    emailMe: "Email Me",
    downloadResume: "Request CV",
    email: "Email",
    linkedin: "LinkedIn",
    github: "GitHub",
    note: "Email is best. Typical response within 24 hours.",
  },
  projects: {
    title: "Projects",
    intro:
      "A selection of shipped products, internal platforms, and AI experiences with measurable outcomes.",
    featuredLabel: "Featured work",
    walkthrough: "Request walkthrough",
    readBlogs: "Read engineering notes",
    ndaNote:
      "More client work is available on request, including private demos and architecture walkthroughs under NDA.",
  },
...
const th: Dict = {
  ...
  about: {
    title: "เกี่ยวกับฉัน",
    p1: "Senior Full-Stack Developer ที่สร้างผลิตภัณฑ์โดยยึดหลัก SOLID และ Design Patterns — ออกแบบโค้ดเบสที่ขยายได้อย่างปลอดภัยและเสถียรบน production",
    p2pre: "นำทีม 3 คนตั้งแต่ขั้น discovery จนถึง deploy production และออกแบบ",
    p2highlight: "ระบบ Smart Building IoT",
    p2post:
      "ที่ให้บริการลูกค้า B2B 3 ราย — ลดเวลา API จาก ~8s → ~2s และลดโหลด backend ลง ~33%",
    p3pre: "พร้อมเปิดตัวแอป BLE Healthcare ที่รวม IoT หลายเจ้าบน ",
    p3mid: "",
    p3highlight: "Google Play & App Store",
    p3post: " มองหาบทบาท Senior Full-Stack เพื่อส่งมอบผลิตภัณฑ์ด้วยมาตรฐาน engineering ที่เข้มงวด ทั้งด้านความปลอดภัยและความเสถียรในการใช้งานจริง",
  ...
  contact: {
    ...
    downloadResume: "ขอ CV",
    email: "อีเมล",
    linkedin: "LinkedIn",
    github: "GitHub",
    note: "ติดต่อทางอีเมลจะสะดวกที่สุด ปกติตอบกลับภายใน 24 ชั่วโมง",
  },
  projects: {
    title: "ผลงาน",
    intro:
      "ตัวอย่างผลงานที่ส่งมอบจริง ทั้งผลิตภัณฑ์ ระบบภายใน และประสบการณ์ AI พร้อมผลลัพธ์ที่วัดได้",
    featuredLabel: "ผลงานเด่น",
    walkthrough: "ขอ walkthrough",
    readBlogs: "อ่านบันทึกวิศวกรรม",
    ndaNote:
      "ยังมีงานลูกค้าเพิ่มเติมที่สามารถเล่าให้ฟังได้เมื่อร้องขอ รวมถึง private demo และ architecture walkthrough ภายใต้ NDA",
  },
...
const zh: Dict = {
  ...
  about: {
    title: "关于我",
    p1: "高级全栈开发工程师，秉持 SOLID 原则和成熟的设计模式构建产品 —— 打造可安全扩展、生产环境稳定的代码库。",
    p2pre: "带领 3 人团队从需求探索到生产部署，独立构建",
    p2highlight: "智能楼宇 IoT 平台",
    p2post:
      "，已服务 3 家 B2B 客户 —— API 延迟从 ~8 秒降至 ~2 秒，后端负载降低约 33%。",
    p3pre: "同时发布了集成多厂商蓝牙设备的医疗 App 至 ",
    p3mid: "",
    p3highlight: "Google Play 与 App Store",
    p3post: "。寻求一个高级全栈职位，以工程严谨性、安全性和运营稳定性交付产品。",
    statYears: "年经验",
    statProjects: "已交付项目",
    statResearch: "研究合作",
    statCloud: "云端部署",
  ...
  contact: {
    ...
    linkedin: "领英",
    github: "GitHub",
    note: "邮件联系最合适，通常会在 24 小时内回复。",
  },
  projects: {
    title: "项目",
    intro: "精选已交付产品、内部平台与 AI 体验，并附上可量化的成果。",
    featuredLabel: "精选项目",
    walkthrough: "申请讲解",
    readBlogs: "阅读工程笔记",
    ndaNote:
      "如有需要，我也可以分享更多客户项目，包括在 NDA 前提下的私密演示与架构讲解。",
  },
...
const ja: Dict = {
  ...
  about: {
    title: "私について",
    p1: "シニアフルスタック開発者として、SOLID 原則と確立されたデザインパターンに基づき、安全にスケールし本番環境で安定稼働するコードベースを構築。",
    p2pre: "3 名のチームを率いて要件定義から本番リリースまでを担い、",
    p2highlight: "スマートビルディング IoT プラットフォーム",
    p2post:
      "を設計・実装。3 社の B2B クライアントへ提供し、API レイテンシを ~8 秒から ~2 秒へ、バックエンド負荷を約 33% 削減。",
    p3pre: "さらに複数ベンダー対応の BLE ヘルスケアアプリを ",
    p3mid: "",
    p3highlight: "Google Play & App Store",
    p3post: " でリリース。エンジニアリングの厳密さ、セキュリティ、運用安定性で製品を届けるシニアフルスタックポジションを希望。",
    statYears: "年の経験",
  ...
  contact: {
    ...
    emailMe: "メールを送る",
    downloadResume: "CV を依頼",
    email: "メール",
    linkedin: "LinkedIn",
    github: "GitHub",
    note: "メールが最も確実です。通常 24 時間以内に返信します。",
  },
  projects: {
    title: "プロジェクト",
    intro:
      "実際に提供したプロダクト、社内プラットフォーム、AI 体験の中から、成果が明確なものを厳選しています。",
    featuredLabel: "注目の実績",
    walkthrough: "ウォークスルーを依頼",
    readBlogs: "技術ノートを読む",
    ndaNote:
      "ご要望があれば、NDA 前提で非公開デモやアーキテクチャ解説を含む追加事例も共有できます。",
  },
